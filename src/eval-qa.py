...
if __name__ == '__main__':
    ...
    # Add arguments
    #parser.add_argument('-pp','--predictions_path', type=str, metavar='', default=preds_path, required=False, help='Predictions path.')
    parser.add_argument('-lg','--language', type=str, metavar='', default="english", required=False, help='Language for tokenize.')
    parser.add_argument('-enci','--encoder_info', type=str, metavar='', default="questiongen_text", required=False, help='Information for encoding.')
